...
from core.helpers import construct_operation_value_string, construct_where_clause_string, recursive_dict_merge
...
class TestHelpers:
    ...
    def test_construct_operation_value_string(
        self, value, operation, expected
    ):
    ...
    def test_construct_where_clause_string(self):
        ...
        assert result == 'A: {A1 {_eq: V1}} B: {B1: {B11 {_eq: V2} B13 {_eq: V3}}} C {_eq: V4}'
