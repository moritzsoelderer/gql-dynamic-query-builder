...
class TestGQLDynamicQueryBuilderNestedFieldsAndExplicitClauses:
    ...
    def test_build_with_api_where_clause_one_op_one_value_nested_field_explicit_clause(
    ...
    @pytest.mark.parametrize('query,subquery_to_test', ALL_QUERIES)
    def test_build_with_api_where_clause_one_op_many_values_nested_field_explicit_clause(
        self, query, subquery_to_test
    ):
        builder = GQLDynamicQueryBuilder(query)
        builder.with_where_clause(
    ...
    @pytest.mark.parametrize('query,subquery_to_test', ALL_QUERIES)
    def test_build_with_api_where_clause_many_ops_many_values_nested_field_explicit_clause(
        self, query, subquery_to_test
    ):
        builder = GQLDynamicQueryBuilder(query)
        builder.with_where_clause(
